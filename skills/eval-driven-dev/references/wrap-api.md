...
| `pixie format <file.jsonl>`                                                               | Convert a trace file to a formatted dataset entry template. Shows `entry_kwargs`, `test_case.eval_input`, and `eval_output` (the real captured output). |
