...
__export(typespecs_exports, {
  ...
  createAclSchema: () => createAclSchema,
  ...
  insertDatasetEventBaseSchema: () => insertDatasetEventBaseSchema,
  insertEventsResponseSchema: () => insertEventsResponseSchema,
  insertExperimentEventBaseSchema: () => insertExperimentEventBaseSchema,
  insertFunctionEventBaseSchema: () => insertFunctionEventBaseSchema,
  insertProjectLogsEventBaseSchema: () => insertProjectLogsEventBaseSchema,
  insertPromptEventBaseSchema: () => insertPromptEventBaseSchema,
  insertPromptSessionEventBaseSchema: () => insertPromptSessionEventBaseSchema,
  ...
  orgSecretsSchema: () => orgSecretsSchema,
...
var literalSchema = import_zod.z.union([
  import_zod.z.string().openapi({ title: "string" }),
  import_zod.z.number().openapi({ title: "number" }),
  import_zod.z.boolean().openapi({ title: "boolean" }),
  import_zod.z.null().openapi({ title: "null" })
]);
var jsonSchema = import_zod.z.lazy(
  () => import_zod.z.union([
    literalSchema,
    import_zod.z.array(jsonSchema).openapi({ title: "array" }),
    import_zod.z.record(jsonSchema).openapi({ title: "object" })
  ])
);
var datetimeStringSchema = import_zod.z.string().transform((x, ctx) => {
  const d = new Date(x);
  if (isNaN(d.getTime())) {
    ctx.addIssue({
      code: import_zod.z.ZodIssueCode.invalid_string,
      validation: "datetime",
...
var messageRoleSchema = import_zod3.z.enum([
  "system",
  "user",
  "assistant",
  "function",
...
var chatCompletionSystemMessageParamSchema = import_zod3.z.object({
  content: import_zod3.z.string().default(""),
  role: import_zod3.z.literal("system"),
  name: import_zod3.z.string().optional()
});
var chatCompletionContentPartTextSchema = import_zod3.z.object({
  text: import_zod3.z.string().default(""),
  type: import_zod3.z.literal("text")
});
var imageURLSchema = import_zod3.z.object({
  url: import_zod3.z.string(),
  detail: import_zod3.z.union([
    import_zod3.z.literal("auto").openapi({ title: "auto" }),
    import_zod3.z.literal("low").openapi({ title: "low" }),
    import_zod3.z.literal("high").openapi({ title: "high" })
  ]).optional()
});
var chatCompletionContentPartImageSchema = import_zod3.z.object({
...
var chatCompletionContentSchema = import_zod3.z.union([
  import_zod3.z.string().default("").openapi({ title: "text" }),
  import_zod3.z.array(chatCompletionContentPartSchema).openapi({ title: "array" })
]);
var chatCompletionUserMessageParamSchema = import_zod3.z.object({
  content: chatCompletionContentSchema,
  role: import_zod3.z.literal("user"),
  name: import_zod3.z.string().optional()
});
var functionCallSchema = import_zod3.z.object({
  arguments: import_zod3.z.string(),
  name: import_zod3.z.string()
});
var functionSchema = import_zod3.z.object({
  arguments: import_zod3.z.string(),
  name: import_zod3.z.string()
});
var chatCompletionToolMessageParamSchema = import_zod3.z.object({
  content: import_zod3.z.string().default(""),
  role: import_zod3.z.literal("tool"),
  tool_call_id: import_zod3.z.string().default("")
});
var chatCompletionFunctionMessageParamSchema = import_zod3.z.object({
  content: import_zod3.z.string().default(""),
  name: import_zod3.z.string(),
  role: import_zod3.z.literal("function")
});
var chatCompletionMessageToolCallSchema = import_zod3.z.object({
  id: import_zod3.z.string(),
  function: functionSchema,
  type: import_zod3.z.literal("function")
});
var chatCompletionAssistantMessageParamSchema = import_zod3.z.object({
...
var chatCompletionFallbackMessageParamSchema = import_zod3.z.object({
...
var chatCompletionOpenAIMessageParamSchema = import_zod3.z.union([
...
var functionDefinitionSchema = import_zod4.z.object({
  name: import_zod4.z.string(),
  description: import_zod4.z.string().optional(),
  parameters: functionParametersSchema.optional()
});
var chatCompletionToolSchema = import_zod4.z.object({
...
var openAIModelParamsSchema = import_zod5.z.object({
  ...
  response_format: import_zod5.z.object({ type: import_zod5.z.literal("json_object") }).nullish(),
  tool_choice: import_zod5.z.union([
    import_zod5.z.literal("auto").openapi({ title: "auto" }),
    import_zod5.z.literal("none").openapi({ title: "none" }),
    import_zod5.z.object({
      type: import_zod5.z.literal("function"),
      function: import_zod5.z.object({ name: import_zod5.z.string() })
...
var anthropicModelParamsSchema = import_zod5.z.object({
...
var googleModelParamsSchema = import_zod5.z.object({
  temperature: import_zod5.z.number().optional(),
  maxOutputTokens: import_zod5.z.number().optional(),
  topP: import_zod5.z.number().optional(),
  topK: import_zod5.z.number().optional()
});
var windowAIModelParamsSchema = import_zod5.z.object({
  temperature: import_zod5.z.number().optional(),
  topK: import_zod5.z.number().optional()
});
var jsCompletionParamsSchema = import_zod5.z.object({});
...
var viewTypeEnum = import_zod6.z.enum([
  "projects",
  "logs",
  "experiments",
  "datasets",
...
var viewDataSearchSchema = import_zod6.z.object({
  filter: import_zod6.z.array(customTypes.any).nullish(),
  tag: import_zod6.z.array(customTypes.any).nullish(),
  match: import_zod6.z.array(customTypes.any).nullish(),
  sort: import_zod6.z.array(customTypes.any).nullish()
}).strip().openapi("ViewDataSearch");
var viewDataSchema = import_zod6.z.object({
  search: viewDataSearchSchema.nullish()
}).strip().openapi("ViewData");
var viewOptionsSchema = import_zod6.z.object({
  columnVisibility: import_zod6.z.record(import_zod6.z.boolean()).nullish(),
  columnOrder: import_zod6.z.array(import_zod6.z.string()).nullish(),
  columnSizing: import_zod6.z.record(import_zod6.z.number()).nullish()
...
function generateBaseTableSchema(objectName, opts) {
  ...
  return import_zod7.z.object({
    id: import_zod7.z.string().uuid().describe(`Unique identifier for the ${objectName}`),
    project_id: import_zod7.z.string().uuid().describe(
      `Unique identifier for the project that the ${objectName} belongs under`
    ),
    name: import_zod7.z.string().describe(nameDescription),
    description: import_zod7.z.string().nullish().describe(`Textual description of the ${objectName}`),
    ...
    user_id: import_zod7.z.string().uuid().nullish().describe(`Identifies the user who created the ${objectName}`),
    metadata: import_zod7.z.record(customTypes.any).nullish().describe(`User-controlled metadata about the ${objectName}`)
  });
}
var userBaseSchema = generateBaseTableSchema("user");
var userSchema = import_zod7.z.object({
  id: userBaseSchema.shape.id,
  given_name: import_zod7.z.string().nullish().describe("Given name of the user"),
  family_name: import_zod7.z.string().nullish().describe("Family name of the user"),
  email: import_zod7.z.string().nullish().describe("The user's email"),
  avatar_url: import_zod7.z.string().nullish().describe("URL of the user's Avatar image"),
  created: userBaseSchema.shape.created
}).openapi("User");
var organizationBaseSchema = generateBaseTableSchema("organization");
var organizationSchema = import_zod7.z.object({
  id: organizationBaseSchema.shape.id,
  name: organizationBaseSchema.shape.name,
  api_url: import_zod7.z.string().nullish(),
  is_universal_api: import_zod7.z.boolean().nullish(),
  proxy_url: import_zod7.z.string().nullish(),
  realtime_url: import_zod7.z.string().nullish(),
  created: organizationBaseSchema.shape.created
}).openapi("Organization");
var maxOverWindowSchema = import_zod7.z.object({
  window_size_days: import_zod7.z.number().int().positive(),
  max_value: import_zod7.z.number().nonnegative()
}).openapi("MaxOverWindow");
var resourcesSchema = import_zod7.z.object({
  org_id: organizationSchema.shape.id,
  forbid_toggle_experiment_public_to_private: import_zod7.z.boolean().nullish(),
  num_private_experiment_row_actions: maxOverWindowSchema.nullish(),
  forbid_insert_datasets: import_zod7.z.boolean().nullish(),
  forbid_insert_prompt_sessions: import_zod7.z.boolean().nullish(),
  forbid_access_sql_explorer: import_zod7.z.boolean().nullish(),
  num_production_log_row_actions: maxOverWindowSchema.nullish(),
  num_dataset_row_actions: maxOverWindowSchema.nullish()
}).openapi("Resources");
var memberSchema = import_zod7.z.object({
  org_id: organizationSchema.shape.id,
  user_id: userSchema.shape.id
}).openapi("Member");
var orgSecretsBaseSchema = generateBaseTableSchema("org secrets");
var orgSecretsSchema = import_zod7.z.object({
  id: orgSecretsBaseSchema.shape.id,
  created: orgSecretsBaseSchema.shape.created,
  key_id: import_zod7.z.string().uuid(),
  org_id: organizationSchema.shape.id,
  name: orgSecretsBaseSchema.shape.name,
  secret: import_zod7.z.string().nullish(),
  type: import_zod7.z.string().nullish(),
  metadata: customTypes.any
}).openapi("OrgSecrets");
var apiKeyBaseSchema = generateBaseTableSchema("api key");
var apiKeySchema = import_zod7.z.object({
  id: apiKeyBaseSchema.shape.id,
  created: apiKeyBaseSchema.shape.created,
  name: apiKeyBaseSchema.shape.name,
  preview_name: import_zod7.z.string(),
  user_id: userSchema.shape.id.nullish(),
  org_id: organizationSchema.shape.id.nullish()
}).openapi("ApiKey");
var projectSettingsSchema = import_zod7.z.object({
  comparison_key: import_zod7.z.string().nullish().describe("The key used to join two experiments (defaults to `input`).")
});
var projectBaseSchema = generateBaseTableSchema("project");
var projectSchema = import_zod7.z.object({
  id: projectBaseSchema.shape.id,
  org_id: import_zod7.z.string().uuid().describe(
...
var datasetSchema = import_zod7.z.object({
...
var promptSchemaObject = import_zod7.z.object({
  ...
  tags: import_zod7.z.array(import_zod7.z.string()).nullish().describe("A list of tags for the prompt"),
  metadata: promptBaseSchema.shape.metadata
});
var promptSchema = promptSchemaObject.openapi("Prompt");
var codeBundleSchema = import_zod7.z.object({
  runtime_context: import_zod7.z.object({
    runtime: validRuntimesEnum,
    version: import_zod7.z.string()
  }),
  ...
  location: import_zod7.z.object({
    type: import_zod7.z.literal("experiment"),
    eval_name: import_zod7.z.string(),
    position: import_zod7.z.union([
      import_zod7.z.literal("task").openapi({ title: "task" }),
      import_zod7.z.object({ score: import_zod7.z.number() }).openapi({ title: "score" })
    ])
  }),
  bundle_id: import_zod7.z.string()
});
var functionDataSchema = import_zod7.z.union([
  import_zod7.z.object({
    type: import_zod7.z.literal("prompt")
    // For backwards compatibility reasons, this is hoisted out and stored
    // in the outer object
  }).openapi({ title: "prompt" }),
  import_zod7.z.object({
    type: import_zod7.z.literal("code"),
    data: codeBundleSchema
  }).openapi({ title: "code" }),
  import_zod7.z.object({
    type: import_zod7.z.literal("global"),
...
var repoInfoSchema = import_zod7.z.object({
  commit: import_zod7.z.string().nullish().describe("SHA of most recent commit"),
  branch: import_zod7.z.string().nullish().describe("Name of the branch the most recent commit belongs to"),
  tag: import_zod7.z.string().nullish().describe("Name of the tag on the most recent commit"),
  dirty: import_zod7.z.boolean().nullish().describe(
    "Whether or not the repo had uncommitted changes when snapshotted"
  ),
  author_name: import_zod7.z.string().nullish().describe("Name of the author of the most recent commit"),
  author_email: import_zod7.z.string().nullish().describe("Email of the author of the most recent commit"),
  commit_message: import_zod7.z.string().nullish().describe("Most recent commit message"),
  commit_time: import_zod7.z.string().nullish().describe("Time of the most recent commit"),
  git_diff: import_zod7.z.string().nullish().describe(
...
var experimentSchema = import_zod7.z.object({
  ...
  commit: import_zod7.z.string().nullish().describe("Commit, taken directly from `repo_info.commit`"),
  base_exp_id: import_zod7.z.string().uuid().nullish().describe(
    "Id of default base experiment to compare against when viewing this experiment"
  ),
  deleted_at: experimentBaseSchema.shape.deleted_at,
  dataset_id: import_zod7.z.string().uuid().nullish().describe(
    "Identifier of the linked dataset, or null if the experiment is not linked to a dataset"
  ),
  dataset_version: import_zod7.z.string().nullish().describe(
    "Version number of the linked dataset the experiment was run against. This can be used to reproduce the experiment after the dataset has been modified."
  ),
  public: import_zod7.z.boolean().describe(
...
var promptSessionSchema = import_zod7.z.object({
...
var permissionEnum = import_zod7.z.enum([
  "create",
  "read",
  "update",
  "delete",
...
var aclObjectTypeEnum = import_zod7.z.enum([
  "organization",
  "project",
  "experiment",
  "dataset",
...
var roleSchema = import_zod7.z.object({
  id: roleBaseSchema.shape.id,
  org_id: import_zod7.z.string().uuid().nullish().describe(
    [
  ...
  member_permissions: import_zod7.z.array(
    import_zod7.z.object({
  ...
  member_roles: import_zod7.z.array(import_zod7.z.string().uuid()).nullish().describe(
    [
...
var groupSchema = import_zod7.z.object({
  ...
  member_users: import_zod7.z.array(import_zod7.z.string().uuid()).nullish().describe("Ids of users which belong to this group"),
  member_groups: import_zod7.z.array(import_zod7.z.string().uuid()).nullish().describe(
    [
...
var projectScoreTypeEnum = import_zod7.z.enum(["slider", "categorical", "weighted", "minimum"]).describe("The type of the configured score");
var projectScoreCategory = import_zod7.z.object({
  name: import_zod7.z.string().describe("Name of the category"),
  value: import_zod7.z.number().describe(
...
var projectScoreSchema = import_zod7.z.object({
  ...
  categories: import_zod7.z.union([
    projectScoreCategory.array().describe(
      "For categorical-type project scores, the list of all categories"
    ).openapi({ title: "categorical" }),
    import_zod7.z.record(import_zod7.z.number()).describe(
      "For weighted-type project scores, the weights of each score"
    ).openapi({ title: "weighted" }),
    import_zod7.z.array(import_zod7.z.string()).describe(
      "For minimum-type project scores, the list of included scores"
    ).openapi({ title: "minimum" })
  ]).nullish(),
  config: import_zod7.z.object({
    multi_select: import_zod7.z.boolean().nullish(),
    destination: import_zod7.z.literal("expected").nullish()
  }).nullish(),
  position: import_zod7.z.string().nullish().describe(
...
var projectTagSchema = import_zod7.z.object({
  ...
  color: import_zod7.z.string().nullish().describe("Color of the tag for the UI")
}).describe(
...
var viewSchema = import_zod7.z.object({
  id: viewBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod7.z.string().uuid().describe("The id of the object the view applies to"),
...
var aclSchema = import_zod7.z.object({
  id: aclBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod7.z.string().uuid().describe("The id of the object the ACL applies to"),
  user_id: import_zod7.z.string().uuid().nullish().describe(
    "Id of the user the ACL applies to. Exactly one of `user_id` and `group_id` will be provided"
  ),
  group_id: import_zod7.z.string().uuid().nullish().describe(
  ...
  role_id: import_zod7.z.string().uuid().nullish().describe(
    "Id of the role the ACL grants. Exactly one of `permission` and `role_id` will be provided"
  ),
  _object_org_id: import_zod7.z.string().uuid().describe("The organization the ACL's referred object belongs to"),
...
var appLimitSchema = import_zod7.z.number().int().nonnegative().describe("Limit the number of objects to return");
function generateBaseTableOpSchema(objectName) {
  return import_zod7.z.object({
    org_name: import_zod7.z.string().nullish().describe(
...
var startingAfterSchema = import_zod7.z.string().uuid().describe(
  [
    "Pagination cursor id.",
    "For example, if the final item in the last page you fetched had an id of `foo`, pass `starting_after=foo` to fetch the next page. Note: you may only pass one of `starting_after` and `ending_before`"
  ].join("\n\n")
).openapi("StartingAfter");
var endingBeforeSchema = import_zod7.z.string().uuid().describe(
  [
    "Pagination cursor id.",
...
function makeObjectIdsFilterSchema(objectName) {
  const item = import_zod7.z.string().uuid();
  return import_zod7.z.union([item, item.array()]).describe(
...
var createProjectSchema = import_zod7.z.object({
  name: projectSchema.shape.name,
  org_name: createProjectBaseSchema.shape.org_name
}).openapi("CreateProject");
var patchProjectSchema = import_zod7.z.object({
...
var createExperimentSchema = import_zod7.z.object({
  ...
  ensure_new: import_zod7.z.boolean().nullish().describe(
...
var createDatasetSchema = import_zod7.z.object({
...
var patchDatasetSchema = import_zod7.z.object({
...
var patchPromptSchema = import_zod7.z.object({
...
var patchFunctionSchema = import_zod7.z.object({
...
var createGroupSchema = import_zod7.z.object({
...
var createProjectScoreSchema = import_zod7.z.object({
...
var patchProjectScoreSchema = import_zod7.z.object({
...
var createProjectTagSchema = import_zod7.z.object({
...
var patchProjectTagSchema = import_zod7.z.object({
...
var patchViewSchema = import_zod7.z.object({
...
var deleteViewSchema = import_zod7.z.object({
  object_type: viewSchema.shape.object_type,
  object_id: viewSchema.shape.object_id
}).openapi("DeleteView");
var patchOrganizationSchema = import_zod7.z.object({
...
var createApiKeySchema = import_zod7.z.object({
  name: import_zod7.z.string().describe("Name of the api key. Does not have to be unique"),
  org_name: createApiKeyBaseSchema.shape.org_name
});
var createApiKeyOutputSchema = apiKeySchema.merge(
  import_zod7.z.object({
    key: import_zod7.z.string().describe("The raw API key. It will only be exposed this one time")
  })
).openapi("CreateApiKeyOutput");
var organizationMembersSchema = import_zod7.z.object({
  members: userSchema.pick({ id: true, email: true }).array()
}).openapi("OrganizationMembers");
var patchOrganizationMembersSchema = import_zod7.z.object({
  invite_users: import_zod7.z.object({
    ...
    send_invite_emails: import_zod7.z.boolean().nullish().describe(
  ...
  remove_users: import_zod7.z.object({
  ...
  org_id: import_zod7.z.string().nullish().describe(
...
var patchOrganizationMembersOutputSchema = import_zod7.z.object({
  status: import_zod7.z.literal("success"),
  send_email_error: import_zod7.z.string().nullish().describe(
...
function objectNullish(object) {
  return new import_zod8.z.ZodObject({
    ...object._def,
...
// typespecs/api_types.ts
(0, import_zod_to_openapi4.extendZodWithOpenApi)(import_zod9.z);
var auditSourcesSchema = import_zod9.z.enum(VALID_SOURCES);
function generateBaseEventOpSchema(objectType) {
  ...
  return import_zod9.z.object({
    ...
    [TRANSACTION_ID_FIELD]: import_zod9.z.string().describe(
    ...
    tags: import_zod9.z.array(import_zod9.z.string()).nullish().describe("A list of tags to log"),
    scores: import_zod9.z.record(import_zod9.z.number().min(0).max(1).nullish()).nullish(),
    metadata: import_zod9.z.record(customTypes.any).nullish().describe(
      "A dictionary with additional data about the test example, model outputs, or just about anything else that's relevant, that you can use to help find and analyze examples later. For example, you could log the `prompt`, example's `id`, or anything else that would be useful to slice/dice later. The values in `metadata` can be any JSON-serializable type, but its keys must be strings"
    ),
    metrics: import_zod9.z.object({
      start: import_zod9.z.number().nullish().describe(
        `A unix timestamp recording when the section of code which produced the ${eventDescription} event started`
      ),
      end: import_zod9.z.number().nullish().describe(
        `A unix timestamp recording when the section of code which produced the ${eventDescription} event finished`
      ),
      prompt_tokens: import_zod9.z.number().int().nullish().describe(
        `The number of tokens in the prompt used to generate the ${eventDescription} event (only set if this is an LLM span)`
      ),
      completion_tokens: import_zod9.z.number().int().nullish().describe(
        `The number of tokens in the completion generated by the model (only set if this is an LLM span)`
      ),
      tokens: import_zod9.z.number().int().nullish().describe(
    ...
    context: import_zod9.z.object({
      caller_functionname: import_zod9.z.string().nullish().describe(
        `The function in code which created the ${eventDescription} event`
      ),
      caller_filename: import_zod9.z.string().nullish().describe(
        `Name of the file in code where the ${eventDescription} event was created`
      ),
      caller_lineno: import_zod9.z.number().int().nullish().describe(
    ...
    span_id: import_zod9.z.string().uuid().describe(
    ...
    span_parents: import_zod9.z.string().array().nullish().describe(
    ...
    root_span_id: import_zod9.z.string().uuid().describe(
      `The \`span_id\` of the root of the trace this ${eventDescription} event belongs to`
    ),
    span_attributes: import_zod9.z.object({
      name: import_zod9.z.string().nullish().describe("Name of the span, for display purposes only"),
      type: import_zod9.z.enum(spanTypeAttributeValues).nullish().describe("Type of the span, for display purposes only")
    }).catchall(customTypes.any).nullish().describe(
      "Human-identifying attributes of the span, such as name, type, etc."
    ),
    [OBJECT_DELETE_FIELD]: import_zod9.z.boolean().nullish().describe(
...
function generateBaseEventFeedbackSchema(objectType) {
  ...
  return import_zod9.z.object({
    ...
    scores: import_zod9.z.record(import_zod9.z.number().min(0).max(1).nullish()).nullish().describe(
    ...
    tags: import_zod9.z.array(import_zod9.z.string()).nullish().describe("A list of tags to log"),
    comment: import_zod9.z.string().nullish().describe(
...
var fetchLimitSchema = import_zod9.z.number().int().nonnegative().describe(
  [
...
var maxXactIdSchema = import_zod9.z.string().describe(fetchPaginationCursorDescription);
var maxRootSpanIdSchema = import_zod9.z.string().describe(fetchPaginationCursorDescription);
var fetchPaginationCursorSchema = import_zod9.z.string().describe(
  [
...
var versionSchema = import_zod9.z.string().describe(
  [
...
var pathTypeFilterSchema = import_zod9.z.object({
  type: import_zod9.z.literal("path_lookup").describe("Denotes the type of filter as a path-lookup filter"),
  path: import_zod9.z.string().array().describe(
...
var sqlTypeFilterSchema = import_zod9.z.object({
  type: import_zod9.z.literal("sql_filter").describe("Denotes the type of filter as a sql-type filter"),
  expr: import_zod9.z.string().describe(
...
var allFetchFiltersSchema = import_zod9.z.union([pathTypeFilterSchema, sqlTypeFilterSchema]).array().describe(
...
var fetchEventsRequestSchema = import_zod9.z.object({
...
function makeFetchEventsResponseSchema(objectType, eventSchema) {
  ...
  return import_zod9.z.object({
    ...
    cursor: import_zod9.z.string().nullish().describe(
      [
        "Pagination cursor",
...
var experimentEventSchema = import_zod9.z.object({
  id: experimentEventBaseSchema.shape.id,
  dataset_record_id: import_zod9.z.string().nullish().describe(
...
var datasetEventSchema = import_zod9.z.object({
...
var promptSessionEventSchema = import_zod9.z.object({
...
var projectLogsEventSchema = import_zod9.z.object({
  ...
  log_id: import_zod9.z.literal("g").describe("A literal 'g' which identifies the log as a project log"),
...
var mergeEventSchema = import_zod9.z.object({
  [IS_MERGE_FIELD]: customTypes.literalTrue.describe(isMergeDescription),
  [MERGE_PATHS_FIELD]: import_zod9.z.string().array().array().nullish().describe(
    [
...
var replacementEventSchema = import_zod9.z.object({
  [IS_MERGE_FIELD]: customTypes.literalFalse.nullish().describe(isMergeDescription),
  [PARENT_ID_FIELD]: import_zod9.z.string().nullish().describe(
    [
...
function makeInsertEventSchemas(objectType, insertSchema) {
  ...
  const eventSchema = import_zod9.z.union([replaceVariantSchema, mergeVariantSchema]).describe(`${capitalize(article)} ${eventDescription} event`).openapi(`Insert${eventSchemaName}Event`);
  const requestSchema = import_zod9.z.object({
...
var insertEventsResponseSchema = import_zod9.z.object({
  row_ids: import_zod9.z.string().array().describe(
...
function makeCrossObjectIndividualRequestSchema(objectType) {
  ...
  const insertObject = import_zod9.z.object({
  ...
  return import_zod9.z.record(import_zod9.z.string().uuid(), insertObject).nullish().describe(
...
function makeCrossObjectIndividualResponseSchema(objectType) {
  return import_zod9.z.record(import_zod9.z.string().uuid(), insertEventsResponseSchema).nullish().describe(
    `A mapping from ${objectType} id to row ids for inserted \`events\``
  );
}
var crossObjectInsertRequestSchema = import_zod9.z.object({
...
var crossObjectInsertResponseSchema = import_zod9.z.object({
...
var summarizeScoresParamSchema = import_zod9.z.boolean().describe(
  "Whether to summarize the scores and metrics. If false (or omitted), only the metadata will be returned."
);
var comparisonExperimentIdParamSchema = import_zod9.z.string().uuid().describe(
...
var summarizeDataParamSchema = import_zod9.z.boolean().describe(
  "Whether to summarize the data. If false (or omitted), only the metadata will be returned."
);
var summarizeExperimentResponseSchema = import_zod9.z.object({
  project_name: import_zod9.z.string().describe("Name of the project that the experiment belongs to"),
  experiment_name: import_zod9.z.string().describe("Name of the experiment"),
  project_url: import_zod9.z.string().url().describe("URL to the project's page in the Braintrust app"),
  experiment_url: import_zod9.z.string().url().describe("URL to the experiment's page in the Braintrust app"),
  comparison_experiment_name: import_zod9.z.string().nullish().describe("The experiment which scores are baselined against"),
  scores: import_zod9.z.record(
    import_zod9.z.object({
      name: import_zod9.z.string().describe("Name of the score"),
      score: import_zod9.z.number().min(0).max(1).describe("Average score across all examples"),
      diff: import_zod9.z.number().min(-1).max(1).optional().describe(
        "Difference in score between the current and comparison experiment"
      ),
      improvements: import_zod9.z.number().int().min(0).describe("Number of improvements in the score"),
      regressions: import_zod9.z.number().int().min(0).describe("Number of regressions in the score")
    }).describe("Summary of a score's performance").openapi("ScoreSummary")
  ).nullish().describe("Summary of the experiment's scores"),
  metrics: import_zod9.z.record(
    import_zod9.z.object({
      name: import_zod9.z.string().describe("Name of the metric"),
      metric: import_zod9.z.number().describe("Average metric across all examples"),
      unit: import_zod9.z.string().describe("Unit label for the metric"),
      diff: import_zod9.z.number().optional().describe(
        "Difference in metric between the current and comparison experiment"
      ),
      improvements: import_zod9.z.number().int().min(0).describe("Number of improvements in the metric"),
      regressions: import_zod9.z.number().int().min(0).describe("Number of regressions in the metric")
...
var summarizeDatasetResponseSchema = import_zod9.z.object({
  project_name: import_zod9.z.string().describe("Name of the project that the dataset belongs to"),
  dataset_name: import_zod9.z.string().describe("Name of the dataset"),
  project_url: import_zod9.z.string().url().describe("URL to the project's page in the Braintrust app"),
  dataset_url: import_zod9.z.string().url().describe("URL to the dataset's page in the Braintrust app"),
  data_summary: import_zod9.z.object({
    total_records: import_zod9.z.number().int().min(0).describe("Total number of records in the dataset")
...
var invokeFunctionNonIdArgsSchema = import_zod10.z.object({
  input: import_zod10.z.any().optional().describe(
    "Argument to the function, which can be any JSON serializable value"
  ),
  parent: import_zod10.z.union([
    import_zod10.z.object({
      object_type: import_zod10.z.enum(["project_logs", "experiment"]),
...
var runEvalSchema = import_zod10.z.object({
  ...
  metadata: import_zod10.z.record(import_zod10.z.unknown()).optional().describe(
