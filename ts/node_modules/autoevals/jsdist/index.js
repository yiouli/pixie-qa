...
async function OpenAIClassifier(args) {
  ...
  const messages = messagesArg.map((m) => ({
    ...m,
...
var ValidJSON = makePartial(async ({ output, schema }) => {
  return {
    name: "ValidJSON",
...
var entitySchema = import_zod.z.object({
  entities: import_zod.z.array(import_zod.z.string())
});
...
context: {{context}}
candidate sentences: `;
var relevantSentencesSchema = import_zod.z.object({
  sentences: import_zod.z.array(
    import_zod.z.object({
      sentence: import_zod.z.string().describe("The selected sentence"),
      reasons: import_zod.z.array(import_zod.z.string()).describe(
...
classification:
`;
var contextRecallSchema = import_zod.z.object({
  statements: import_zod.z.array(
    import_zod.z.object({
      statement: import_zod.z.string(),
      attributed: import_zod.z.number(),
...
verification:
`;
var contextPrecisionSchema = import_zod.z.object({
  reason: import_zod.z.string().describe("Reason for verification"),
  verdict: import_zod.z.number().describe("Binary (0/1) verdict of verification")
});
...
answer:
`;
var extractedStatementsSchema = import_zod.z.object({
  statements: import_zod.z.array(import_zod.z.string()).describe("the list of extracted statements")
});
var statementFaithfulnessSchema = import_zod.z.object({
  faithfulness: import_zod.z.array(
    import_zod.z.object({
      statement: import_zod.z.string().describe("the original statement, word-by-word"),
      verdict: import_zod.z.number().describe("the verdict(0/1) of the faithfulness."),
      reason: import_zod.z.string().describe("the reason of the verdict")
    })
  )
});
...
output:
`;
var questionGenSchema = import_zod.z.object({
  question: import_zod.z.string(),
  noncommittal: import_zod.z.number()
});
...
`;
var answerCorrectnessClassificationSchema = import_zod.z.object({
  TP: import_zod.z.array(import_zod.z.string()),
  FP: import_zod.z.array(import_zod.z.string()),
  FN: import_zod.z.array(import_zod.z.string())
});
