 ...
 */
export declare function simpleNormInv(data: NumberArray, options?: SimpleNormInvOptions): Float64Array<ArrayBuffer>;
/**
 ...
 */
export declare function simpleNormInvNumber(data: number, options?: SimpleNormInvOptions): number;
export {};
//# sourceMappingURL=simpleNormInv.d.ts.map